          ...
          <div className="p-4 sm:p-6 md:p-8 min-h-[260px] sm:min-h-[280px]">
            ...
            {activeTab === "transit" && (
              <div key="transit" className="relative bg-gray-100/90 rounded-xl p-6 -m-2">
                ...
                <p className="pricing-note-highlight text-sm font-bold font-body text-foreground mt-3 leading-relaxed rounded-lg bg-gradient-to-r from-primary/15 via-amber-50 to-primary/15 border-2 border-primary/50 px-3 py-3 ring-1 ring-primary/20">
                  <span className="text-primary">Note:</span> Any price or amount shown by this tool is an{" "}
                  <span className="text-primary">estimate only</span> and is not a final quote. For accurate, binding pricing, please call the numbers listed in the{" "}
                  <a href="/#contact" className="text-primary underline decoration-primary/60 underline-offset-2 hover:decoration-primary font-extrabold">
                    Contact
                  </a>{" "}
                  section.
                </p>
